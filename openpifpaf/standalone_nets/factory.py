...
class Factory(Configurable):
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument('--use-transformer',
                           default=False,
                           action='store_true',
                           help='use transformer instead of resnet as backbone')
        # group.add_argument('--use-concat',default=False,action='store_true',
        #                    help='concat centernet results to relation predictions')
    ...
    def from_scratch(self, head_metas,mode,use_transformer) -> nets.Shell:
