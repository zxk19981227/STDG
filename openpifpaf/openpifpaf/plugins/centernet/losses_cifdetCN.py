...
class CifDet_CNLoss(torch.nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        # print(f"depth gt is {depth_gt}")
        # depth_information=depth_information.squeeze(1)
        # print(f"depth information is {depth_information}")
        # print(f"depth shape is {depth_gt.shape}")
        # print(f"depth information shapeis {depth_information.shape}")
        # depth_loss=self.depth(depth_gt,depth_information.squeeze(1))
        if self.n_scales>0:
