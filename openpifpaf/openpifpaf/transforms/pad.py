...
class CenterPad(Preprocess):
    ...
    def __call__(self, image, anns, meta,depth):
        ...
        image, anns, ltrb,depth = self.center_pad(image, anns,depth)
        meta['offset'] -= ltrb[:2]
    ...
    def center_pad(self, image, anns,depth):
        w, h = image.size
        ...
        depth=torchvision.transforms.functional.pad(
            depth, ltrb, fill=(124, 116, 104))
        # pad annotations
        for ann in anns:
